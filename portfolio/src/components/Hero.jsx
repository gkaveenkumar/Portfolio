    ...
    <section id="hero" className="hero">
      ...
      <div className="hero-content">
        ...
        <h1>
          ...
          <br />
          <span className="line2">Kaveen Kumar</span>
        </h1>

        <p className="hero-sub">
          Data Analyst &amp; ML Engineer — building pipelines that turn raw data into business clarity.
        </p>
      ...
      <div className="hero-img-wrap">
        <div className="hero-img-ring">
          ...
          <img src="/photo.jpg" alt="Kaveen Kumar G" />
        </div>
      </div>
    </section>
  );
